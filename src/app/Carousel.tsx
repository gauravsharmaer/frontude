...
const AutoSlidingCarousel = () => {
    ...
    return (
        <section className="h-screen w-full flex flex-col relative items-center px-[80px] py-4 overflow-y-scroll">
            ...
            />
            <div className="absolute inset-0 bg-black/70 -z-20 transition-[mask-position] duration-8000 ease-in-out" />
            ...
            <div className="carousel-container relative w-full mt-8">
                <div className="slides w-full flex items-center justify-center transition-transform duration-500 mb-[60px]" style={{ transform: `translateX(-${currentSlide * 100}%)` }}>
                    {testimonials.map((slide, index) => (
                        <div key={index} className="slide w-full flex items-center justify-center flex-shrink-0">
                            <div className="card flex flex-col items-center px-8 py-4 w-[60%] relative overflow-hidden">

                                <h3 className="mt-6 text-[32px] text-center hoverable">{slide.description}</h3>
                                <div className='flex items-center w-auto gap-8 mt-[40px]'>
                                    <p className=" text-white">{slide.client}</p>
                                    <div className='w-[2px] h-[20px] bg-[#d6180a]'>
                                    </div>
