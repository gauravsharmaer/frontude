...
const Services = () => {
    return (
        <section className="h-screen w-full flex flex-col relative items-center px-[80px] py-4 overflow-y-scroll">
            <Image
                src={Background}
                alt="Background"
                layout="fill"
                ...
                <div className="bgblue w-full">
                    <div className="card flex flex-col items-start px-8 py-4 relative overflow-hidden">
                        ...
                        <p className="mt-8 text-white">
                            We design and develop <b className="text-[#d6180a]">web</b>, <b className="text-[#d6180a]">mobile</b> and <b className="text-[#d6180a]">desktop</b> applications that are visually appealing and user-friendly. Our team of experts will work with you to create an app that meets your needs and exceeds your expectations.
                        </p>
                    </div>
                </div>
                <div className="bgblue w-full">
                    <div className="card flex flex-col items-start px-8 py-4 relative overflow-hidden">
                        ...
                        <p className="mt-8 text-white">
                            We provide cloud and DevOps services to help you <b className="text-[#d6180a]">build</b>, <b className="text-[#d6180a]">deploy</b>, and <b className="text-[#d6180a]">manage</b> applications in the cloud. Our team of experts will work with you to design a solution that meets your needs and exceeds your expectations.
                        </p>
                    </div>
                </div>
                <div className="bgblue w-full">
                    <div className="card flex flex-col items-start px-8 py-4 relative overflow-hidden">
                        ...
                        <p className="mt-8 text-white">
                            Our team of experts will work with you to design a user-friendly interface that meets your needs and exceeds your expectations. We ensure that the design is both <b className="text-[#d6180a]">functional</b> and <b className="text-[#d6180a]">aesthetically</b> pleasing.
                        </p>
                    </div>
                </div>
            </div>
