      ...
      <div className="sticky top-0 w-full h-screen flex items-center justify-center px-4 sm:px-6 md:px-8">
        <TextReveal
          text="Frontude will change the way you design. 
                Experience a new level of creativity and efficiency in your projects.With intuitive tools and a user-friendly interface,Frontude empowers designers to bring their visions to life effortlessly. 
                "
